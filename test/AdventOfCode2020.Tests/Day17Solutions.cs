...
namespace AdventOfCode2020.Tests
{
    public class Day17Solutions : TestBase
    {
        ...
        [Fact]
        public void Puzzle1_FindActiveCubesAfterBoot()
        {
            var grid = new Grid(Input.Day17);
...
###";
        ...
        public void Grid_IngestsInputCorrectly()
        {
            ...
            grid.Cubes.Should().HaveCount(9);
            grid.Count(x => x.IsActive).Should().Be(5);
        }

        [Fact]
        public void BuildModsWithLoops()
        {
